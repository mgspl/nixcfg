...

{
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      exec-once = gammastep -m wayland -t 6500:3000 -l $(curl -s 'http://ip-api.com/json/?fields=lat,lon' | jq -r '"\(.lat):\(.lon)"')
    '';
    ...
    settings = {
      ...
      bind = [
        ...
        "$mainMod, R, exec, uwsm app -- rofi -show drun"
        "$mainMod, T, exec, uwsm app -- kitty"

        "$mainMod, M, exec, hyprpanel -t powermenu"

        ",Print, exec, uwsm app -- wayfreeze --after-freeze-cmd 'hyprshot -m region -o ~/Imagens/; killall wayfreeze'"
